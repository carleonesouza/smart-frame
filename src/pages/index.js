...
import Hemelt from 'react-helmet'
    ...
    return(
        ...
        <Hemelt>
           ...
           <div className='bg-gray-200 md:overflow-hidden'>
                        <div className='px-4 py-16'>
                            <div className='relative w-full md:max-w-2xl md:mx-auto text-center'>
                                <h1 className='font-bold text-gray-700 text-xl sm:text-2xl md:text-5xl leading-tight mb-6'>
                                    A simple and smart tool that will help grow your business</h1>
                        ...
                        <svg className='fill-current bg-gray-200 text-white hidden md:block'
                    ...
                    <div className='max-w-4xl mx-auto bg-white shadow-lg relative z-20 hidden md:block'
                        style={{marginTop: '-320px', borderRadius: '20px'}}>
                        <div className='h-20 w-20 rounded-full bg-yellow-500 absolute top-0 left-0 -ml-10 -mt-10'
                            style={{zIndex: '-1'}}></div>

                        <div className='h-5 w-5 rounded-full bg-blue-500 absolute top-0 left-0 -ml-32 mt-12'
                            style={{zIndex: '-1'}}></div>
                    ...
                    <div className='px-4 md:hidden'>
                        <div className='-mt-10 max-w-4xl mx-auto bg-white shadow-lg relative z-20'
